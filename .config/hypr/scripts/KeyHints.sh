...
" T" "Terminal" "(kitty)" \
" Enter" "DropDown Terminal" "(kitty-pyprland)" \
...
" ALT W" "Choose wallpaper effects" "(imagemagick + swww)" \
"CTRL ALT W" "Random wallpaper" "(via swww)" \
" B" "Hide/UnHide Waybar" "waybar" \
"CTRL Shift B" "Choose waybar styles" "(waybar styles)" \
"CTRL ALT B" "Choose waybar layout" "(waybar layout)" \
...
" Shift F" "Full Screen" "single window" \
